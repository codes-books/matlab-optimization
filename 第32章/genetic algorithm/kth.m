...
%% 寻优分析
Up=150:2:400;%作为 Ultrasonic power(W) 输入
Utp=20:2:80;%作为 Ultrasonic temperature(oC) 输入
Ut=5:2:35;%作为 Ultrasonic time(min) 输入
...
actual_result=test_result(b,:);% 得到预测最大值
